  ...
  $price = $_POST['price'];
	...
	if(empty($menu_item) or empty($price)){
		$message = "please fill the informations";
				...
				$query = "INSERT INTO sub_menu(sub_item_id,menu_item,sub_menu_item,menu_info,price) VALUES ('','$menu_item','$sub_menu_item','$menu_info','$price')";
...
?>
        ...
        <div class="col-sm-4">
        <input type="text" class="form-control" name="sub_menu_item" placeholder="Food Name">
        </div>
        </div>

        <div class="form-group">
        <label for="menu_info" class="col-sm-4 control-label">Add Food Decription</label>
        <div class="col-sm-4">
        <input type="text" class="form-control" name="menu_info" placeholder="Decription">
        </div>
        </div>
