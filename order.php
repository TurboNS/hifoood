    ...
    <div class="clearfix" style="margin:1px auto; border-bottom:1px solid #FFF;"></div>
        ...
        <?php
          ...
          <?php
                ...
                <!-- Sub Menu -->
                    ...
                    while($submenu_row = mysqli_fetch_assoc($submenu_query)){?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="booking_left_1 sub_menu_item"> <?php echo $submenu_row['menu_info']?></a></div>
                            </div>
                ...
                <div style=" padding:15px 0px;"><input type="submit" name="submit" style=" style="position:fixed;"" value="Submit" class="btn btn-danger">
                </div>
            ...
            <?php                       
                        ...
                        $cust_id = "CUST_".$_SESSION["sess_user"];
