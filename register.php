...
if(isset($_POST['register'])){
	...
	if(empty($username) or empty($password)){
		$message = "please fill the informations";
				...
				$query = "INSERT INTO users(id,name,username,password) VALUES ('','$name', '$username','$password')";
...
?>
<p class="lead">Full Name: <input type='text' name='name'placeholder="Full name"></p>
<p class="lead">Username: <input type='text' name='username' placeholder="Your Email"></p>
...
<a href="adminregister.php" class="btn btn-warning" role="button">ADMIN REGISTER</a>
