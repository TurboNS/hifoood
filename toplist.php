    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          ...
          <a href="restaurant1.php" class="btn btn-info" role="button">Sample Restaurant</a>
        </h4>
      </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          ...
          <a href="restaurant1.php" class="btn btn-info" role="button">Super Restaurant</a>
        </h4>
      </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          ...
          <a href="restaurant1.php" class="btn btn-info" role="button">Random Restaurant</a>
        </h4>
      </div>
     ...
     <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          ...
          <a href="restaurant1.php" class="btn btn-info" role="button">Best Restaurant</a>
        </h4>
      </div>
